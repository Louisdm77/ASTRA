import Trust from "../assets/Images/trustpilot.jpg";
        ...
        <div className="h-full">
          ...
          <div className="p-2">
            <p className="text-center">
              Based on{" "}
              <span className="font-bold text-gray-800">1873+ Reviews</span>
            </p>
          </div>
        </div>
      </div>
      <div className="w-[50%]">
        <div className="h-full">
          ...
          <div className="p-2">
            <p className="text-center">
              Based on{" "}
              <span className="font-bold text-gray-800">5083+ Reviews</span>
            </p>
          </div>
        </div>
      </div>
